...
<head>
    ...
    <div class="isi">
        ...
        <tr>
            ...
            <tr><td class="td-label">Jenis Kelamin</td><td>: {{ $surat->pengajuan->user->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</td>
            <tr><td class="td-label">Agama</td><td>: {{ $surat->pengajuan->user->agama ?? '-' }}</td>
        ...
        <p>Adalah benar berdomisili dan bertempat tinggal di Desa Rambatan Wetan, Kecamatan Sindang, Kabupaten Indramayu.</p>
