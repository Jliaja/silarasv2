...
<body>
    ...
    <div class="isi">
        ...
        <p>Adalah benar memiliki usaha :</p>

        <table>
            <tr><td class="td-label">Nama Usaha</td><td>: {{ json_decode($surat->pengajuan->data_pengajuan, true)['nama_usaha'] ?? '-' }}</td>
            <tr><td class="td-label">Jenis Usaha</td><td>: {{ json_decode($surat->pengajuan->data_pengajuan, true)['jenis_usaha'] ?? '-' }}</td>
            <tr><td class="td-label">Alamat Usaha</td><td>: {{ json_decode($surat->pengajuan->data_pengajuan, true)['alamat_usaha'] ?? '-' }}</td>
            <tr><td class="td-label">Tahun Berdiri</td><td>: {{ json_decode($surat->pengajuan->data_pengajuan, true)['tahun_berdiri'] ?? '-' }}</td>
        </table>

        <p>Usaha tersebut benar berada di wilayah Desa Rambatan Wetan dan masih aktif sampai saat ini.</p>
